            ...
            "parameters": {
                ...
                "properties": {
                    "story": {
                        "type": "string",
                        "description": (
                            "Write your story. Include: (1) What you see in your cyan memory box, "
                            "(2) What you see OUTSIDE the memory box - check all screen corners, "
                            "(3) Any time or clock visible?, (4) What you will do next and why. "
                            "Write 5-7 sentences total."
                        ),
                    }
                },
                "required": ["story"],
